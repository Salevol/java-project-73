...
class TaskStatusControllerTest {
    ...
    public void getTaskStatusById() throws Exception {
        ...
        utils.regDefaultTaskStatus(TEST_EMAIL).andExpect(status().isCreated());
    ...
    public void getTaskStatusByIdFails() throws Exception {
        utils.regDefaultUser();
        utils.regDefaultTaskStatus(TEST_EMAIL);
    ...
    public void twiceCreateTaskStatusFail() throws Exception {
        utils.regDefaultUser();
        utils.regDefaultTaskStatus(TEST_EMAIL).andExpect(status().isCreated());
        utils.regDefaultTaskStatus(TEST_EMAIL).andExpect(status().isUnprocessableEntity());
